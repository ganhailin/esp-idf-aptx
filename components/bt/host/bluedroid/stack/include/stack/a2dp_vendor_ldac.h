...
#include "stack/a2dp_error_codes.h"
#include "stack/a2dp_constants.h"
...
extern tA2D_STATUS A2DP_ParseInfoLDAC(tA2DP_LDAC_CIE* p_ie,const uint8_t* p_codec_info,bool is_capability,char *caller_s);
