...
static void dequantizeQuantUnit( channel_t* this, int band )
{
    ...
    {
        const ldacdec_float_t coarse = this->quantizedSpectra[subBandIndex+sb] * stepSize;
        const ldacdec_float_t fine = this->quantizedSpectraFine[subBandIndex+sb] * stepSizeFine;
...
static const ldacdec_float_t spectrumScale[32] =
{
